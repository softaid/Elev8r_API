...
module.exports = function (Common, oauth, log, dev) {
    ...
    router.get('/purchaserequest/:companyid/statusid/:statusid/moduleid/:moduleid/', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
    ...
    router.get('/iteminstock/:itemid/:warehousebinid/:transactiondate/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
            let result = await Common.getItemInStock(request, request.params);
            response.send(result);
        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("Common-getItemInStock", err);
        }
    });
    ...
    //get items
    router.get('/itemlivestock/:itemgroupid/:warehouseid/:warehousebinid/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
    ...
    router.get('/userlogout/:userid/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
            ...
            response.send(result);
            console.log("-------------_*___*********result", result);
        }
        catch (err) {
            console.log(' Error in router : ', err);
    ...
    // get modulewise and batchwise shed

    router.get('/getshedbatchwise/:moduleid/:batchid', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getBatchWiseShed(request, request.params);
            response.send(result);
            console.log("-------------_*___*********result", result);
            ...
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getBatchWiseShed", err);
        }
    });

    // get modulewise and batchwise cumulative feed consumption

    router.get('/getbatchwiseCumFeedCon/:batchid/:shedid/:transactiondate/:moduleid/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getBatchWiseCumulativeFeedConsumption(request, request.params);
            console.log("*********CONSUMPTION************", result);
            response.send(result);
        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getBatchWiseCumulativeFeedConsumption", err);
        }
    });

    // get common dashboard 

    router.get('/commondashboard1/company_id/:company_id/to_date/:to_date', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getCommonDashboard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getCommonDashboard", err);
        }
    });

    //get itemwise instock

    router.get('/warehousewiseiteminstock/:itemid/:warehouseid/:transactiondate/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getItemAndWarehousewiseInstock(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getItemAndWarehousewiseInstock", err);
        }
    });


    /**
     * Service to juarnal entry serach bu parammeter
     */
    router.get('/commondashboard1/jE/company_id/:company_id/transaction_id/:transaction_id/vouchertype_id/:vouchertype_id', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getJaurnalEntryDetail(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getJaurnalEntryDetail", err);
        }
    });

    // modulewise dashboards
    router.get('/modulewisedashboards/:moduleid', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.modulewiseDashboards(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-modulewiseDashboards", err);
        }
    });

    // get breeder setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardbreedersetting/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getBreederSettingForDashBoard(request, request.params);
            ...
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getBreederSettingForDashBoard", err);
        }
    });

    // get layer setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardlayersetting/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getLayerSettingForDashBoard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getLayerSettingForDashBoard", err);
        }
    });

    // get common setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardsettingdata/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getCommonSettingForDashBoard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getCommonSettingForDashBoard", err);
        }
    });


    // get cbf setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardcbfsetting/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getCBFSettingForDashBoard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getCBFSettingForDashBoard", err);
        }
    });

    // get Hatchery setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardhatcherysetting/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getHatcherySettingForDashBoard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getHatcherySettingForDashBoard", err);
        }
    });

    // get Feed Mill setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardfeedmillsetting/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {

        try {
            let result = await Common.getFeedMillSettingForDashBoard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getFeedMillSettingForDashBoard", err);
        }
    });

    // get Processing setting data for common dashboard to idintify which fields are blank
    router.get('/commondashboardproccessingsetting/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
            let result = await Common.getProcessingSettingForDashBoard(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getProcessingSettingForDashBoard", err);
        }
    });

    // get Processing setting data for common dashboard to idintify which fields are blank
    router.get('/getmoduleacessbyuser/:userid/:company_id', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
            let result = await Common.getModuleDatabyUser(request, request.params);
            response.send(result);

        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("common-getModuleDatabyUser", err);
        }
    });

    //SEARCH SERVICE
    router.get('/settingstatussearch/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
            let result = await Common.getSettingStatusResult(request, request.params);
            response.send(result);
        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("Common-getSettingStatusResult", err);
        }
    });

    // SELECT SERVICE
    router.get('/settingstatusselect/:id/:companyid', oauth.ensureLoggedIn, async function (request, response, next) {
        try {
            let result = await Common.getSettingStatus(request, request.params);
            response.send(result);
        }
        catch (err) {
            console.log(' Error in router : ', err);
            log.dbErrorLog("Common-getSettingStatus", err);
        }
    });

    //SAVE SERVICE
    router.post('/', oauth.ensureLoggedIn, async function (request, response, next) {
        let rows = await Common.saveSettingStatus(request, request.body);
